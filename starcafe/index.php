      ...
      <div class="tm-left">
        <div class="tm-left-inner">
          <div class="tm-site-header">
            ...
            <h1 class="tm-site-name">Star Cafe</h1>
          </div>
        ...
        <main class="tm-main">
          <div id="drink" class="tm-page-content">
            ...
            <nav class="tm-black-bg tm-drinks-nav">
              <ul>
                <li>
                  <a href="#" class="tm-tab-link active" data-id="milkshakes">Milk Shakes</a>
                </li>
                <li>
                  <a href="#" class="tm-tab-link" data-id="mojito">Mojito</a>
                </li>
                <li>
                  <a href="#" class="tm-tab-link" data-id="masalalemonade">Masala Lemonade</a>
                </li>
                <li>
                  <a href="#" class="tm-tab-link" data-id="ice">Ice</a>
                </li>
                <li>
                  <a href="#" class="tm-tab-link" data-id="hot">Hot</a>
                </li>
              </ul>
            </nav>

            <div id="milkshakes" class="tm-tab-content">
              <div class="tm-list">
                <div class="tm-list-item">          
                  <img src="img/iced-americano.png" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Iced Americano<span class="tm-list-item-price">Rs 200</span></h3>
                ...
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Iced Cappuccino<span class="tm-list-item-price">Rs 200</span></h3>
                ...
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Iced Espresso<span class="tm-list-item-price">Rs 200</span></h3>
                ...
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Iced Latte<span class="tm-list-item-price">Rs 200</span></h3>
            ...
            <div id="mojito" class="tm-tab-content">
              <div class="tm-list">
              
                <div class="tm-list-item">          
                  <img src="img/hot-americano.png" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Hot Americano<span class="tm-list-item-price">Rs 200/span></h3>
                ...
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Hot Cappuccino<span class="tm-list-item-price">Rs 200/span></h3>
                ...
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Hot Espresso<span class="tm-list-item-price">Rs 200/span></h3>
                ...
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Hot Latte<span class="tm-list-item-price">Rs 200/span></h3>
            ...
            <div id="masalalemonade" class="tm-tab-content">
              <div class="tm-list">
                <div class="tm-list-item">          
                  <img src="img/smoothie-1.png" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Strawberry Smoothie<span class="tm-list-item-price">Rs 200</span></h3>
                    <p class="tm-list-item-description">Here is a short description for the item along with a squared thumbnail.</p>              
                  </div>
                </div>
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Red Berry Smoothie<span class="tm-list-item-price">Rs 200</span></h3>
                    <p class="tm-list-item-description">Here is a list of 4 items or add more. You can use this template for commercial purposes.</p>                    
                  </div>
                </div>
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Pineapple Smoothie<span class="tm-list-item-price">Rs 200</span></h3>
                    <p class="tm-list-item-description">Left side logo and main menu are fixed. The video background is fixed.</p>              
                  </div>
                </div>
                <div class="tm-list-item">          
                  ...
                  <div class="tm-black-bg tm-list-item-text">
                    <h3 class="tm-list-item-name">Spinach Smoothie<span class="tm-list-item-price">Rs 200</span></h3>
                    <p class="tm-list-item-description">You are not allowed to redistribute the template ZIP file on other template sites.</p>              
                  </div>
                </div>              
              </div>
            </div>
            <div id="ice" class="tm-tab-content">
              <div class="tm-list">
                <div class="tm-list-item">          
                  <img src="img/smoothie-1.png" alt="Image" class="tm-list-item-img">
                  <div class="tm-black-bg tm-list-item-text">
            ...
            <div class="tm-special-items">
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h2 class="tm-text-primary tm-special-item-title">Pasta</h2>
              ...
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h2 class="tm-text-primary tm-special-item-title">Pizza</h2>
              ...
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h2 class="tm-text-primary tm-special-item-title">Burger</h2>
              ...
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h2 class="tm-text-primary tm-special-item-title">Sandwitch</h2>
              ...
              <div class="tm-black-bg tm-special-item">
                ...
                <div class="tm-special-item-description">
                  <h2 class="tm-text-primary tm-special-item-title">Maggie</h2>
